...
class Factory extends WorkingStructure {
    get weapon() { return weapons.weapons[this.structure.weaponIndex]; }

    // Resources required to generate a single bullet
    get bulletResources() { return this.weapon.bulletResources || [0, 0, 0]; }

    get laborDemand() { return this.weapon.laborDemand || 1; }

    get maxCount() { return this.weapon.maxAmmo; }

    get generationRate() { return this.weapon.generationRate || 1; }
